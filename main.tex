...
\begin{frame}
    ...
    \begin{itemize}
        \item<1-> Elliptic curves are everywhere in cryptography
        \item<2-> Power $\approx 70\%$ of TLS Exchanges
        \item<3-> Coolest post quantum cryptography proposal
        \item<4-> Fascinating mathematically
    \end{itemize}
\end{frame}
